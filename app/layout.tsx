...
export const metadata: Metadata = {
  title: "Daemons Build | Elite Technical Agency",
  ...
  openGraph: {
    ...
    url: "https://daemons.build", // Replace with your actual domain later
    siteName: "Daemons Build",
    images: [
      {
        url: "/og-image.png", // We will add this image next
        width: 1200,
        height: 630,
        alt: "Daemons Build Preview",
      },
    ],
    locale: "en_US",
    type: "website",
